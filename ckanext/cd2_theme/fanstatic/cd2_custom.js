...
function createLegendString(input) {
    const dict = {
        ...
        'W': 'Twin pair',
        'V': 'Intimate partner',
        'U': 'Best friend of target',
        'Y': 'Best friend of sibling',
        'V': 'Best friend of intimate partner',
        'Z': 'Best friend of sibling\'s intimate partner',
        'K': 'Parent of intimate partner',
        'L': 'Parent of sibling\'s intimate partner',
        'MC': 'mother-child',
        'PC': 'parent-child',
        'FC': 'father-child',
        'P1': 'Primary parent',
