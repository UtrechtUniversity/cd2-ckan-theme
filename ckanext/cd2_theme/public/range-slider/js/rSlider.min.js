(function () {
	...
	var RS = function (conf) {
		...
		this.cls = {
			...
			noscale:	'rs-noscale',
			tip: 		'rs-tooltip',
            alttip: 	'rs-tooltip rs-tooltip-alt'
		};
	...
	RS.prototype.createSlider = function () {
		...
		if (this.conf.tooltip) {
            ...
            this.alttipL = createElement('div', this.cls.alttip);
			this.alttipR = createElement('div', this.cls.alttip);
			this.pointerL.appendChild(this.tipL);
            this.pointerL.appendChild(this.alttipL);
		}
		...
		if (this.conf.range) {
            ...
            this.pointerR.appendChild(this.alttipR);
	...
	RS.prototype.setValues = function (start, end) {
		...
		if (this.conf.range) {
			if (this.conf.tooltip) {
				if (this.conf.values[this.values.start] < 24) {
					this.tipL.innerHTML = this.conf.values[this.values.start];
					this.alttipL.innerHTML = 'months';
				} else {
					this.tipL.innerHTML = Math.round(this.conf.values[this.values.start]/12);
					this.alttipL.innerHTML = 'years';
				}
				if (this.conf.values[this.values.end] < 24) {
					this.tipR.innerHTML = this.conf.values[this.values.end]
					this.alttipR.innerHTML = 'months'; 
				} else {
					this.alttipR.innerHTML = Math.round(this.conf.values[this.values.end]/12);
					this.alttipR.innerHTML = 'years';
				}
			}
